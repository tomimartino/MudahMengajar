...
- Shares screenshots of the actual UI/dashboard to confirm where to perform a step (e.g., adding env vars in Vercel) rather than describing the screen in text, expecting the assistant to read the image. Confidence: 0.6
- When confused by a technical explanation, asks for a more detailed, plain-language walkthrough starting from the basics; responds well to step-by-step instructions with concrete analogies. Confidence: 0.8
